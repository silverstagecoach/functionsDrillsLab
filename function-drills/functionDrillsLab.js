...
//CODE HERE
const compareNums = (numberOne, numberTwo) => {Math.max(numberOne, numberTwo)}
console.log(compareNums(14, 15))
...
let nameGreeting = nameCheck(`Deuteronomy`)
...
const thatsOdd = numberOne => {
  if (numberOne) {
    ...
    if (numberOne % 2 === 0) {
      ...
      console.log(`Try again with a whole number.`)
    } 
  } else {
    console.log(`Woah, there, buckaroo. Let's try again with a number.`)
  }
}
...
console.log(bestMovie(`Return of the Jedi`))
...
//CODE HERE
function bigOrSmall (arrayOfNumbers) {
  let answers = []
...
//CODE HERE
const theEliminator = (contestArr, loser) => {
